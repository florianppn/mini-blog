...
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.4cm}|p{2.9cm}|X|X|}
\hline
\rowcolor{gray!75}
\color{white}\textbf{Opération / ressource} & \color{white}\textbf{Visiteur anonyme} & \color{white}\textbf{Auteur connecté} & \color{white}\textbf{Administrateur} \\
\hline
\rowcolor{gray!10}
Authentification & Inscription / Connexion & Session active & Session active \\
\hline
Articles publiés & Consultation libre & Consultation libre & Modération \& dépublication \\
\hline
\rowcolor{gray!10}
Brouillons (\texttt{DRAFT}) & Inaccessibles & Création, édition \& suppression de ses brouillons & Consultation globale, édition \& publication \\
\hline
Commentaires sur publiés & Lecture seule & Ajout, édition \& suppression de ses écrits & Ajout \& modération de tous les commentaires \\
\hline
\rowcolor{gray!10}
Commentaires sur brouillons & \centering$\times$ Interdit & \centering$\times$ Interdit & \centering\arraybackslash$\times$ Interdit \\
\hline
\end{tabularx}
\end{table}
...
\hline
Articles & Unitaire & Création en brouillon forcé, droits auteur, verrouillage publié, modération admin, workflow publier/dépublier, cascade & 7 & \textcolor{green!50!black}{\checkmark} \\
\hline
\rowcolor{gray!10}
Commentaires & Unitaire & Ajout sur publié, interdiction sur brouillon, modification/suppression auteur, modération admin & 7 & \textcolor{green!50!black}{\checkmark} \\
\hline
Sécurité globale & Intégration & Scénario complet en 15 étapes (création compte, isolation brouillon, publication admin, cascade) & 1 & \textcolor{green!50!black}{\checkmark} \\
\hline
\rowcolor{gray!20}
\multicolumn{3}{|l|}{\textbf{Total (exécutable via \texttt{mvn test})}} & \textbf{18} & \textbf{100\%} \\
\hline
\end{tabularx}
\end{table}
